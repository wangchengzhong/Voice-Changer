...
void RubberBandStretcher::Impl::ChannelData::construct(const std::set<size_t> &sizes,
                                                  size_t initialWindowSize,
                                                  size_t initialFftSize,
                                                  size_t outbufSize)
{
    ...
    // only run one time
    // DBG("ChannelData::construct: initialWindowSize = 2048  " << initialWindowSize << ", initialFftSize = 2048 " << initialFftSize << ", outbufSize = "65536 << outbufSize << "\n");
    ...
    // only one time, size [3], maxSize,4096,realSize,2049,outbufSize,65536
    // DBG("ChannelData::construct([" << sizes.size() << "], " << maxSize << ", " << realSize << ", " << outbufSize << ")\n");
    ...
    // only used for time domain fft i/o
...
void RubberBandStretcher::Impl::ChannelData::setOutbufSize(size_t outbufSize)
{
