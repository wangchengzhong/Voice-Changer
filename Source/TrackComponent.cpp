...
void TrackComponent::valueTreePropertyChanged(ValueTree& v, const Identifier& i)
{
	if(tracktion_engine::Clip::isClipState(v))
	{
		if(i == tracktion_engine::IDs::start || i == tracktion_engine::IDs::length)
		{
...
void TrackComponent::valueTreeChildAdded(ValueTree& parentTree, ValueTree& c)
{
...
void TrackComponent::valueTreeChildRemoved(ValueTree& parentTree, ValueTree& c, int b)
{
	if (tracktion_engine::Clip::isClipState(c))
		markAndUpdate(updateClips);
}
void TrackComponent::valueTreeChildOrderChanged(ValueTree& v, int a, int b)
{
