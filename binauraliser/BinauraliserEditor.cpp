...
//==============================================================================
BinauraliserEditor::BinauraliserEditor (VoiceChanger_wczAudioProcessor* ownerFilter)
...
BinauraliserEditor::~BinauraliserEditor()
{
...
//==============================================================================
void BinauraliserEditor::paint (juce::Graphics& g)
{
...
void BinauraliserEditor::resized()
{
...
void BinauraliserEditor::comboBoxChanged (juce::ComboBox* comboBoxThatHasChanged)
{
...
void BinauraliserEditor::sliderValueChanged (juce::Slider* sliderThatWasMoved)
{
...
void BinauraliserEditor::buttonClicked (juce::Button* buttonThatWasClicked)
{
...
void BinauraliserEditor::timerCallback(int timerID)
{
    switch(timerID){
