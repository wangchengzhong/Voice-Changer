...
/**
    ...
    Describe your class and how it works here!
                                                                    //[/Comments]
*/
class BinauraliserEditor  : public AudioProcessorEditor,
                      public MultiTimer,
...
public:
    //==============================================================================
    BinauraliserEditor (VoiceChanger_wczAudioProcessor* ownerFilter);
    ~BinauraliserEditor() override;
...
private:
    ...
    VoiceChanger_wczAudioProcessor* hVst;
    void* hBin;
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BinauraliserEditor)
};
